...
\begin{figure}[H]
    \begin{center}
        ...
        \begin{tikzpicture}
            ...
            \node[circle,fill=red!20,draw] (1) at (0,4) {$x_1$};
            \node[circle,fill=red!20,draw] (2) at (3.464,2) {$x_2$};
            \node[circle,fill=red!20,draw] (3) at (3.464,-2) {$x_3$};
            \node[circle,fill=red!20,draw] (4) at (0,-4) {$x_4$};
            \node[circle,fill=red!20,draw] (5) at (-3.464,-2) {$x_5$};
        \end{tikzpicture}
